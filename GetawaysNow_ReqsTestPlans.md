...
#### 1. Customer - Sign up:
1. Customer C1 creates a new account using the Sign up page.

#### 2. Provider - Create Listing:
...
#### 5. Customer - Book a Listing:
1. Customer C1 selects the "book now" option on the listing page.
2. C1 selects the desired amount of nights to stay at the location and books the listing.

#### 6. Customer - Write review/favorites (Rate a listing):
1. Customer C1 navigates to a listing they previously booked and favorites it.
...
4. C1 goes to their favorites, and sees the listing they just favorited is there.

#### 7. Provider -  Reply to Review, View Statistics, & Modify listings:
